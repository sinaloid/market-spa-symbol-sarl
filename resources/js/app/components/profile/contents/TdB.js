  ...
  return (
    <>
      ...
      <div className="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-2 g-3">
        ...
        <PieChart title={"Ventes des 6 dernières mois par région"} />
      </div>
      ...
      <div className="row row-cols-1 row-cols-sm-1 row-cols-md-1 row-cols-lg-1 g-3 py-4">
        <div className="col">
          <div className="card o-hidden mb-4">
            <div className="card-header d-flex position-relative">
              ...
              <ButtonLink className="btn-sm position-absolute end-0 mx-3" url={`/profile/${url.dashboard_commandes}`}  name="Ajouter"/>
            </div>
            <div>
          ...
          <div className="card o-hidden mb-4">
            <div className="card-header d-flex position-relative">
              ...
              <ButtonLink className="mx-1"  url={`/profile/produit/${url.dashboard_produit_ajout}`}  name="Produit"/>
              <ButtonLink className="mx-1"  url={`/profile/produit/${url.dashboard_produit_categorie}`}  name="Categorie"/>
              </div>
            </div>
            <div>
              <div className="table-responsive">
        ...
        </div>
        {
          ...
          <div className="card o-hidden mb-4">
            <div className="card-header d-flex position-relative">
              <h3 className="w-50 float-left card-title m-0">Vendeurs</h3>
              <ButtonLink className="btn-sm position-absolute end-0 mx-3" url={`/profile/produit/${url.dashboard_produit_ajout}`}  name="Ajouter"/>
            </div>
            <div>
              <div className="table-responsive">
          ...
          <div className="card o-hidden mb-4">
            <div className="card-header d-flex position-relative">
              <h3 className="w-50 float-left card-title m-0">Acheteur</h3>
              <ButtonLink className="btn-sm position-absolute end-0 mx-3" url={`/profile/produit/${url.dashboard_produit_ajout}`}  name="Ajouter"/>
            </div>
            <div>
              <div className="table-responsive">
